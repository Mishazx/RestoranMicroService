...
import pb2.order_pb2 as order__pb2
...
class OrderServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UpdateOrderStatus = channel.unary_unary(
                ...
                response_deserializer=order__pb2.Order.FromString,
                _registered_method=True)
        self.ConfirmOrderPickup = channel.unary_unary(
                '/order.OrderService/ConfirmOrderPickup',
                request_serializer=order__pb2.ConfirmOrderPickupRequest.SerializeToString,
                response_deserializer=order__pb2.Order.FromString,
                _registered_method=True)
...
def add_OrderServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ConfirmOrderPickup': grpc.unary_unary_rpc_method_handler(
                    servicer.ConfirmOrderPickup,
                    request_deserializer=order__pb2.ConfirmOrderPickupRequest.FromString,
                    response_serializer=order__pb2.Order.SerializeToString,
            ),
    }
...
class OrderService(object):
    ...
    @staticmethod
    def ConfirmOrderPickup(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/order.OrderService/ConfirmOrderPickup',
            order__pb2.ConfirmOrderPickupRequest.SerializeToString,
            order__pb2.Order.FromString,
            options,
            channel_credentials,
            insecure,
